...
//        });
     ...
     * @return
     */
    public List<Permission> sortList(List<Permission> permissionList, String pid, Integer level) {
        ...
        for (Permission current : permissionList) {
            if (current.getPid().equals(pid)){
                ...
                List<Permission> mychildList = sortList(permissionList, current.getPid(), level + 1);
                current.setChildren(mychildList);
            }
        }
